...
- :telescope: SRE interested in distributed systems, performance engineering, and low-level internals.

- :seedling: Currently expanding my technical stack and learning new tools.

- :gear: Neovim enthusiast with a habit of over-ricing my environment (productivity gains pending).

- :zap: In my free time, I attempt to write a blog and think about maybe contributing to OSS.
